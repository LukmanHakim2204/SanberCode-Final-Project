@extends('layout.master',['title' => 'Update Data Films'])
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit New Film</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="card">
                        <div class="card-content">
                            ...
                            @endif
                            <div class="card-body">
                                <form action="{{ route('film.update', $film->id) }}" class="form form-vertical" method="POST"  enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control"
                                                        name="title" placeholder="Input Your Title" value="{{ $film->title }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="summary" id="" cols="30" rows="10" class="form-control"
                                                        placeholder="Input Your Summary">{{ $film->summary }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="first-name-vertical" class="form-control"
                                                        name="release_year" placeholder="Input Release Year Film" value="{{ $film->release_year }}" />
                                                </div>
                                            </div>
