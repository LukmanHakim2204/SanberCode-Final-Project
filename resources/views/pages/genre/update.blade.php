@extends('layout.master',['title' => 'Update Data Genre'])
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Update  Genre</h3>
                    <p class="text-subtitle text-muted">Update Genre Data here !!</p>
                </div>
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ route('genre.update', $genre->id) }}" class="form form-vertical"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-body">
